...
def _get_paths(root_dir, prefix):
    images_filename = prefix + "-images-idx3-ubyte"
    labels_filename = prefix + "-labels-idx1-ubyte"
...
def load_morphomnist_like(root_dir, train: bool = True, columns=None, no_metrics=False, test_prefix='t10k') \
    ...
    """
    prefix = 'train' if train else test_prefix
    images_path, labels_path, metrics_path = _get_paths(root_dir, prefix)
